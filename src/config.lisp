(uiop/package:define-package :aftpd/src/config (:nicknames) (:use :cl)
                             (:shadow)
                             (:export :*logfile* :*xferlog* :*ftpport*
                              :*ftpdataport* :*maxusers* :*toomanymsg*
                              :*pidsfile* :*banner* :*idletimeout*
                              :*transfertimeout* :*connecttimeout*
                              :*badpwdelay* :*max-password-attempts*
                              :*pasvrange* :*pasvipaddrs* :*interface*
                              :*default-umask* :*default-directory-mode*
                              :*anonymous-ftp-names* :*anonymous-ftp-account
                              :*restricted-users* :*unrestricted-users*
                              :*welcome-msg-file* :*message-file*
                              :*quarantine-anonymous-uploads*
                              :*anonymous-chmod-disabled*
                              :*anonymous-rename-disabled*
                              :*anonymous-mkdir-disabled*
                              :*anonymous-rmdir-disabled*
                              :*anonymous-delete-disabled* :*conversions*
                              :*debug* :*test*)
                             (:intern))
(in-package :aftpd/src/config)
;;don't edit above
